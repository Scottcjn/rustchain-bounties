...
A real-world integration of Beacon 2.6+ into OpenClaw AI agents,
demonstrating heartbeat liveness, mayday emergency response,
and property contracts between cooperating agents.
...
AGENT_CONFIGS = {
    "dong": {
        ...
        "description": "AI assistant running on OpenClaw — orchestrates tasks and hunts bounties",
    },
    "scout": {
        "name": "DONG-Scout",
        "role": "worker",
