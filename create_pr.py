...
payload = {"title": "Fix for issue #2784", "body": "Closes #2784\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-2784", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/Scottcjn/rustchain-bounties/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
